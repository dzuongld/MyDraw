...
public:
	...
	//send to back
	void sendBack(CView * cview);

	//bring to front
	void bringFront(CView * cview);

	//group figures
	void groupFigures(CView * cview);

	//ungroup figures
	void ungroupFigures(CView * cview);
